package com.fana.ecom.order.infrastructure.secondary.entity;

import jakarta.persistence.*;
import org.jilt.Builder;

import com.fana.ecom.order.domain.user.aggregate.User;
import com.fana.ecom.order.domain.user.aggregate.UserBuilder;
import com.fana.ecom.order.domain.user.vo.UserAddressBuilder;
import com.fana.ecom.order.domain.user.vo.UserEmail;
import com.fana.ecom.order.domain.user.vo.UserFirstname;
import com.fana.ecom.order.domain.user.vo.UserImageUrl;
import com.fana.ecom.order.domain.user.vo.UserLastname;
import com.fana.ecom.order.domain.user.vo.UserPublicId;
import com.fana.ecom.shared.jpa.AbstractAuditingEntity;
