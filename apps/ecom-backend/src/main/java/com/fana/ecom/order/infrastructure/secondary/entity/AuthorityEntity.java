...
import com.fana.ecom.order.domain.user.aggregate.Authority;
import com.fana.ecom.order.domain.user.aggregate.AuthorityBuilder;
import com.fana.ecom.order.domain.user.vo.AuthorityName;
