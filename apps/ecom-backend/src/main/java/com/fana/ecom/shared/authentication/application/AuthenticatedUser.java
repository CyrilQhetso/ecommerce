...
import com.fana.ecom.shared.authentication.domain.Role;
import com.fana.ecom.shared.authentication.domain.Roles;
import com.fana.ecom.shared.authentication.domain.Username;
...
public final class AuthenticatedUser {
     ...
     */
    public static Username username() throws NotAuthenticatedUserException {
    ...
    Assert.notNull(authentication.toString(), "authentication");
    ...
    try {
        ...
        throw new RuntimeException("Unknown authentication type", e);
    }
}
     ...
     */
    public static Map<String, Object> attributes() throws UnknownAuthenticationException, NotAuthenticatedUserException {
